 ...
 * Date: 24.05.2020.
 */
public class EngineForAnnotationsTest {
    ...
    public void start() {
        ...
        this.engine = new EngineForAnnotations();
    ...
    @Test
    public void testAdd() {
        List<EngineForAnnotations> result = getElementWithoutId(this.engine.getName(), this.engine.getType());
    ...
    public void testUpdate() {
        addElement(this.engine);
        List<EngineForAnnotations> list = getElementWithoutId(this.engine.getName(), this.engine.getType());
        ...
        this.tx(
                session -> {
                    final Query query = session.createQuery("update EngineForAnnotations set name = :name, type = :type where id = :id");
    ...
    private void addElement(EngineForAnnotations element) {
        this.tx(
                session -> session.save(element)
        );
    }

    private List<EngineForAnnotations> getElementWithoutId(String name, String type) {
        return this.tx(
                session -> {
